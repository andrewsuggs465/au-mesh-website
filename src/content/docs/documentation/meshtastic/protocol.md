...
![Radio Spectrum](../../../../assets/meshtastic/Radio-Spectrum-2713191303.png)
...
![Mesh network example](../../../../assets/meshtastic/mesh_network_topology.svg)

## Encryption

Channels such as *LongFast* are encrypted using [**AES-256 (CTR mode)**](/documentation/lectures/encryption-algorithms/) with a pre-shared channel key. Direct messages use public/private key pairs for end-to-end encryption. Messages are cryptographically signed, allowing recipients to verify the sender's identity. Packet headers remain unencrypted to support routing and rebroadcasting.
...
![MQTT](../../../../assets/meshtastic/mqtt-ilustration-1822521187.png)
